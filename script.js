...
function activateButton(id) {
  id === 'all' ? filterAll.classList.add('active') : filterAll.classList.remove('active');
  id === 'active' ? filterActive.classList.add('active') : filterActive.classList.remove('active');
  id === 'completed'
